...
and `ytdl-core`) and assigns them to speakers in a simple round-robin pattern.
Replace `buildResultFromTranscript` with a real diarization pipeline when ready.
