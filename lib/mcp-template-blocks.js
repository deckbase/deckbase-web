...
export function getMcpTemplateBlockCatalog() {
  return {
    ...
    hint:
      "Pick block type keys (e.g. header1, hiddenText) or numeric ids (0–12) in order. Pass them as block_types to create_template. You cannot use blocks and block_types together.",
  };
}
...
/**
 * Build block definitions from an ordered list of type keys or numeric ids (matches template editor defaults).
