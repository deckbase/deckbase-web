 ...
 * Fields: uid, label, created_at, last_used_at
 */
 ...
 * @returns {{ key: string, id: string, label: string, createdAt: string }} - Raw key and metadata
 */
 ...
 * @param {string} uid
 * @returns {Promise<Array<{ id: string, label: string, createdAt: string, lastUsedAt: string | null }>>}
 */
